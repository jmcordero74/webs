    ...
    return (
        <section className="bg-white py-16 px-4 text-gray-800">
            ...
            <div className="flex justify-center mb-10">
                <video
                    src="/videos/fondo/logo.mp4"
                    autoPlay
                    muted
                    loop
                    playsInline
                    preload="auto"
                    className="rounded-xl shadow-lg w-full max-w-2xl h-auto object-cover"
                >
            ...
            <div className="max-w-4xl mx-auto">
                <h2 className="text-3xl md:text-4xl font-bold mb-6 text-center">¿Quiénes Somos?</h2>
            ...
            <div className="mt-10">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-4">
                    ...
                    <img src="/imgs/tienda/tienda4.jpeg" alt="Interior tienda 4" className="rounded-lg shadow-md object-cover w-full h-64" />
                </div>
            </div>
        </section>
    );
